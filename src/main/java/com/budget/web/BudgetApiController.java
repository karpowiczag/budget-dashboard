...
import com.budget.application.BudgetImportService;
import com.budget.application.BudgetQueryService;
import com.budget.application.ImportSummary;
...
public class BudgetApiController {
    ...
    ImportSummary upload(@RequestParam("file") MultipartFile file) {
        return importService.importUpload(file);
    }
